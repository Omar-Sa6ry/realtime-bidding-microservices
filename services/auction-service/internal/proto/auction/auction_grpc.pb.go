...
func (c *auctionServiceClient) ValidateAuctionForBid(ctx context.Context, in *ValidateAuctionRequest, opts ...grpc.CallOption) (*ValidateAuctionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ValidateAuctionResponse)
	err := c.cc.Invoke(ctx, AuctionService_ValidateAuctionForBid_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuctionService_ValidateAuctionForBid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateAuctionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuctionServiceServer).ValidateAuctionForBid(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuctionService_ValidateAuctionForBid_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServiceServer).ValidateAuctionForBid(ctx, req.(*ValidateAuctionRequest))
	}
