...
type AuctionClient interface {
	...
	GetAuction(ctx context.Context, auctionId string) (*pb.GetAuctionResponse, error)
	Close() error
}
...
func (c *auctionClient) GetAuction(ctx context.Context, auctionId string) (*pb.GetAuctionResponse, error) {
